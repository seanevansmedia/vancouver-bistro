      ...
      <div className="w-full bg-[#365314] text-[#ecfccb] rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-20">
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
            ...
            <div>
               ...
               <h2 className="text-4xl md:text-5xl font-black mb-12 text-white text-center md:text-left">
                 Visit Us.
               </h2>
            ...
            {/* STYLED GOOGLE MAP */}
            <div className="h-80 md:h-full min-h-[400px] bg-[#eef5e6] rounded-[2rem] overflow-hidden relative border-4 border-[#4d7c0f]/30 shadow-2xl group">
               <iframe 
